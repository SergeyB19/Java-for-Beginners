...
public class Student {
    ...
    public Student(int numberOfTicket, String name, String surname,
                   int yearOfStudy, double mathGrade,
                   double economicsGrade, double foreignLanguageGrade) {
    ...
    public Student(int numberOfTicket, String name, String surname, int yearOfStudy) {
        this.numberOfTicket = numberOfTicket;
        this.name = name;
        this.surname = surname;
        this.yearOfStudy = yearOfStudy;
...
class StudentTest {
    ...
    public static void main(String[] args) {
        ...
        Student student1 = new Student(1,"Ivan","Ivanov",2005,4,5,7);
        Student student2 = new Student(2,"Petr","Petrov",2006);
